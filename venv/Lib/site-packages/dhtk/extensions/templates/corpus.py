...
class Corpus:
    """
    Create a corpus form books of type `dhtk.templates.Book.`
    ...
    ::
        ...
        from dhtk.templates.corpus import Corpus
    ...
    def __init__(self, name, description="", corpora_path=None, book_list=None):
        ...
        book_list: list(dhtk.templates.book.Book)
    ...
    def get_book_file_name(book):
        ...
        -------
        book_name: str
            This method return to the method in Book of type `dhtk.templates.book` which get the name
    ...
    def to_dict(self):
        ...
        for index, book in enumerate(self._book_list):
            ...
            filename = book.get_text_file_name()
            file_path = os.path.join(self.get_corpus_path(), filename)
            if os.path.exists(file_path):
